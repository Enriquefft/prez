...
function Metric({ value, label }: { value: string; label: string }) {
  return (
    <div className="text-center">
      ...
      <div className="mt-2 text-lg text-white/50 uppercase tracking-widest">{label}</div>
    </div>
  )
}
...
function TeamMember({ name, role, color }: { name: string; role: string; color: string }) {
  return (
    <div className="flex items-center gap-4">
      <div className={`w-16 h-16 rounded-full ${color} flex items-center justify-center text-2xl font-bold text-white/90`}>
        {name[0]}
      </div>
      <div>
    ...
    <>
      ...
      <Slide>
        <div className="flex flex-col items-center justify-center h-full bg-[#0a0a0a] text-white relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            <div className="animate-fade-up text-sm tracking-[0.4em] uppercase text-violet-400 mb-6">Series A</div>
        ...
        <Notes>
          Open strong. Pause 2 seconds on the title before speaking.
          "Thank you for having us. We're Acme AI, and we're building the infrastructure layer for AI-native development."
        </Notes>
      </Slide>
      ...
      <Slide>
        <div className="flex flex-col justify-center h-full bg-[#0a0a0a] text-white px-24">
          <div className="max-w-4xl">
            <p className="text-violet-400 text-sm tracking-[0.3em] uppercase mb-4">The Problem</p>
            ...
            <div className="mt-16 grid grid-cols-3 gap-8">
              <div className="border-l-2 border-red-500/50 pl-6">
                ...
                <div className="mt-2 text-white/40">of AI projects never reach production</div>
              </div>
              <div className="border-l-2 border-orange-500/50 pl-6">
                <div className="text-3xl font-bold text-orange-400">6 mo</div>
                <div className="mt-2 text-white/40">average time to first AI feature</div>
              </div>
              <div className="border-l-2 border-yellow-500/50 pl-6">
                <div className="text-3xl font-bold text-yellow-400">$2.1M</div>
                <div className="mt-2 text-white/40">wasted per failed AI initiative</div>
              </div>
            </div>
          </div>
        </div>
        <Notes>
          Let the stats sink in. These are from Gartner 2025 and our own customer interviews.
          "The gap between wanting AI and shipping AI is enormous."
        </Notes>
      </Slide>
      ...
      <Slide>
        <div className="flex flex-col items-center justify-center h-full bg-[#0a0a0a] text-white">
          <p className="text-violet-400 text-sm tracking-[0.3em] uppercase mb-8">The Solution</p>
          <h2 className="text-5xl font-bold text-center max-w-3xl leading-tight">
            Ship AI features in
            <span className="bg-gradient-to-r from-violet-400 to-cyan-400 bg-clip-text text-transparent"> hours, not months</span>
          </h2>
          <div className="mt-16 flex items-center gap-6">
            <div className="flex flex-col items-center gap-3 w-48">
              ...
              <span className="text-sm text-white/50 text-center">Connect your data</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-3 w-48">
              ...
              <span className="text-sm text-white/50 text-center">Pick a template</span>
            </div>
            <div className="w-12 h-px bg-white/10" />
            <div className="flex flex-col items-center gap-3 w-48">
              ...
              <span className="text-sm text-white/50 text-center">Deploy to production</span>
            </div>
          </div>
        </div>
        <Notes>
      ...
      <Slide>
        <div className="flex flex-col items-center justify-center h-full bg-[#0a0a0a] text-white">
          <p className="text-violet-400 text-sm tracking-[0.3em] uppercase mb-12">Traction</p>
          ...
          <div className="mt-8 flex gap-12 items-center">
            {['Stripe', 'Vercel', 'Linear', 'Notion', 'Figma'].map((name) => (
              <span key={name} className="text-white/20 text-lg font-medium tracking-wide">{name}</span>
            ))}
          </div>
        </div>
        <Notes>
          Hit each metric hard. 180% YoY is our strongest number.
          The logos are real customers — mention Stripe specifically if asked.
        </Notes>
      </Slide>
      ...
      <Slide>
        <div className="flex flex-col justify-center h-full bg-[#0a0a0a] text-white px-24">
          <p className="text-violet-400 text-sm tracking-[0.3em] uppercase mb-4">Business Model</p>
          <h2 className="text-4xl font-bold mb-16">Usage-based pricing that scales with value</h2>
          <div className="grid grid-cols-3 gap-6">
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-8">
              <div className="text-white/40 text-sm uppercase tracking-wider">Starter</div>
              <div className="text-3xl font-bold mt-3">Free</div>
              <div className="text-white/30 mt-1 text-sm">Up to 1K requests/mo</div>
            ...
            <div className="bg-violet-500/10 border border-violet-500/20 rounded-2xl p-8 relative">
              <div className="absolute -top-3 left-8 px-3 py-1 bg-violet-500 text-xs font-semibold rounded-full">Popular</div>
              <div className="text-violet-300 text-sm uppercase tracking-wider">Pro</div>
              <div className="text-3xl font-bold mt-3">$99<span className="text-lg font-normal text-white/40">/mo</span></div>
              <div className="text-white/30 mt-1 text-sm">Up to 100K requests/mo</div>
              <div className="mt-6 space-y-2 text-sm text-white/50">
            ...
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-8">
              <div className="text-white/40 text-sm uppercase tracking-wider">Enterprise</div>
      ...
      <Slide>
        <div className="flex flex-col justify-center h-full bg-[#0a0a0a] text-white px-24">
          <p className="text-violet-400 text-sm tracking-[0.3em] uppercase mb-4">Team</p>
          <h2 className="text-4xl font-bold mb-16">Built by operators who've done it before</h2>
          <div className="grid grid-cols-2 gap-x-16 gap-y-10">
            <TeamMember name="Sarah Chen" role="CEO — Ex-Stripe, Stanford CS" color="bg-violet-600" />
            <TeamMember name="James Park" role="CTO — Ex-Google Brain, MIT" color="bg-cyan-600" />
            <TeamMember name="Maria Garcia" role="VP Eng — Ex-Vercel, 50+ reports" color="bg-emerald-600" />
            <TeamMember name="Alex Kim" role="Head of Growth — Ex-Notion, 0 to $10M" color="bg-orange-600" />
          </div>
        ...
        <Notes>
          Brief bios only. The key point: we've all scaled products at top companies.
          James has 12 ML papers. Maria scaled Vercel's eng org 5x.
        </Notes>
      </Slide>
      ...
      <Slide>
        <div className="flex flex-col items-center justify-center h-full bg-[#0a0a0a] text-white relative">
          ...
          <div className="relative z-10 text-center">
            <p className="text-violet-400 text-sm tracking-[0.3em] uppercase mb-6">The Ask</p>
            <h2 className="text-6xl font-black">
              <span className="bg-gradient-to-r from-violet-400 to-cyan-400 bg-clip-text text-transparent">$18M</span> Series A
            </h2>
        ...
        <Notes>
          Be direct. "$18M to get to $15M ARR in 24 months."
          We already have term sheets. This meeting is about partnership, not desperation.
        </Notes>
      </Slide>
      ...
      <Slide>
        ...
        <Notes>End with confidence. "We'd love to have you on this journey."</Notes>
      </Slide>
    </>
  )
}
